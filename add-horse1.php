...
if(isset($_GET['status'])) {
	...
	if($status == "true"){
		echo 'Horse Profile Created Successfully';
	}
...
<body> 
    ...
    <div class="container-login100">
        <div class="wrap-login100 p-t-50 p-b-90 p-l-50 p-r-50">
            <form class="login100-form flex-sb flex-w" action="add-horse.php" method="POST">
                ...
                <div class="wrap-input100 m-b-16">
                  <input class="input100" type="text" name="breed" placeholder="Breed" required>
                  <span class="focus-input100"></span>
              </div>
              <div class="wrap-input100 m-b-16">
                <input class="input100" type="text" name="color" placeholder="Colour" required>
                <span class="focus-input100"></span>
              </div>
              <div class="wrap-input100 m-b-16">
                <input class="input100" type="text" name="gender" placeholder="Gender[Mare/Stallion]" required>
                <span class="focus-input100"></span>
              </div>
                <div class="container-login100-form-btn m-t-17">
                    <div class="w-full beforeNone text-center">
                        <button type="submit" class="nv-login-submit login100-form-btn" name="add">Add</button>
                    </div>
                </div>
            </form>
        </div>
